...
class Fees(models.Model):
    # course_id = models.ForeignKey('Courses', models.DO_NOTHING, db_column='course_id')
    course_id = models.OneToOneField(Courses, on_delete=models.SET_NULL, blank=True, null=True)
...
class FeesPayment(models.Model):
    ...
    paid_from = models.ForeignKey('Users', models.DO_NOTHING, db_column='paid_from')
